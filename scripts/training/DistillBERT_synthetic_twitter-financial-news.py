...
# === UPDATED: concat HF train + validation, then keep your own stratified split downstream ===
def DataLoad():
    ...
    if "label_text" in df.columns:
        lt = df["label_text"].str.strip().str.title()  # e.g., 'Bearish','Bullish','Neutral'
...
if __name__ == "__main__":
    ...
    # ----------- DATA SELECTION  (Synthetic + Seed merged) -----------
    if USE_SYNTHETIC_DATA:
        ...
        # validation/test come from HF dataset
        full_data = DataLoad()
