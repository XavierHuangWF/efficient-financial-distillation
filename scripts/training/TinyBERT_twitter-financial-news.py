...
FREEZE_LAYERS = 4  # Freezing first N encoder layers (bert-tiny has 2; [:4] safely freezes both)
...
def tokenize_function(example):
    # Keep same structure as your original: instantiate inside for functional parity
...
if __name__ == "__main__":
    ...
    if FREEZE_LAYERS > 0:
        ...
        # For BERT: encoder layers live at model.bert.encoder.layer (ModuleList)
    ...
    # === UPDATED: match dataset label semantics/order ===
