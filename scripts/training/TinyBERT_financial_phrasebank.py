...
# NUM_EPOCHS = 20  # Set to desired number of epochs
# FREEZE_LAYERS = 0  # Set to 0 to fine-tune all layers; 4 = freeze first 4 transformer layers
# USE_SEED_DATA = False  # Set to False to use full training data instead of seed clustering
# USE_EARLY_STOPPING = False  # Set to False to disable early stopping
# USE_CLASS_BALANCED_CLUSTERING = False  # switch for clustering strategy


# # 2. 105 Seed data training set
# NUM_EPOCHS = 20  # Set to desired number of epochs
# FREEZE_LAYERS = 0  # Set to 0 to fine-tune all layers; 4 = freeze first 4 transformer layers
# USE_SEED_DATA = True  # Set to False to use full training data instead of seed clustering
# USE_CLASS_BALANCED_CLUSTERING = False  # switch for clustering strategy
# SAMPLES_PER_CLASS = 35  # fixed number of seed samples per class if class-balanced
# USE_EARLY_STOPPING = False  # Set to False to disable early stopping

#
# # # 3. 105 Seed data + Frozen 4 layer +early stop
# NUM_EPOCHS = 50  # Set to desired number of epochs
# FREEZE_LAYERS = 4  # Set to 0 to fine-tune all layers; 4 = freeze first 4 transformer layers
# USE_SEED_DATA = True  # Set to False to use full training data instead of seed clustering
# USE_CLASS_BALANCED_CLUSTERING = False  # switch for clustering strategy
# SAMPLES_PER_CLASS = 35  # fixed number of seed samples per class if class-balanced
...
FREEZE_LAYERS = 4  # Set to 0 to fine-tune all layers; 4 = freeze first 4 transformer layers
USE_SEED_DATA = True  # Set to False to use full training data instead of seed clustering
USE_CLASS_BALANCED_CLUSTERING = True  # switch for clustering strategy
SAMPLES_PER_CLASS = 35  # fixed number of seed samples per class if class-balanced
USE_EARLY_STOPPING = True  # Set to False to disable early stopping

# # 5. 12 Seed data + Frozen 4 layer + +early stop + class_balance
# NUM_EPOCHS = 50  # Set to desired number of epochs
# FREEZE_LAYERS = 4  # Set to 0 to fine-tune all layers; 4 = freeze first 4 transformer layers
# USE_SEED_DATA = True  # Set to False to use full training data instead of seed clustering
# USE_CLASS_BALANCED_CLUSTERING = True  # switch for clustering strategy
# SAMPLES_PER_CLASS = 4  # fixed number of seed samples per class if class-balanced
# USE_EARLY_STOPPING = True  # Set to False to disable early stopping
