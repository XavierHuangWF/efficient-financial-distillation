...
# === concat HF train + validation, then keep your own stratified split downstream ===
def DataLoad():
...
# ---- NEW: helpers to load/normalize JSONL and merge syn+seed ----
def _normalize_label_to_id(x: str) -> int:
    """Accepts Bearish/Bullish/Neutral or Negative/Positive/Neutral and maps to 0/1/2."""
...
if __name__ == "__main__":
    ...
    if USE_SYNTHETIC_DATA:
        ...
        # Build val/test from the HF dataset
        full_data = DataLoad()
    ...
    # (kept the same) simple ModernBERT freeze
    if FREEZE_LAYERS > 0:
